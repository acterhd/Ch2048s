...
var Manager = function () {
    function Manager() {
        ...
        this.field.ontileabsorption.push(function (old, tile) {
            ...
            if (tile.data.side != old.data.side) {} else {
                tile.value *= 0.5;
            }
