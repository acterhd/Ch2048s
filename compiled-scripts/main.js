...
var Manager = function () {
    function Manager() {
        ...
        this.field.ontilemove.push(function (tile) {
            ...
            var c = Math.max(Math.floor(Math.sqrt(_this.field.data.width / 4 * (_this.field.data.height / 4))), 1);
            for (var i = 0; i < c; i++) {
                if (Math.random() <= 0.5) {
