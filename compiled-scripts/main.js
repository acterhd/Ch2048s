...
var Manager = function () {
    function Manager() {
        ...
        var aftermove = function aftermove(tile) {
            var c = 1;
            var p = _this.data.absorbed ? 0.25 : 1.0;
            for (var i = 0; i < c; i++) {
